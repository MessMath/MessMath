...
public class JsonMaker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Managers.UserMng.user.isCompletedDiagnosis == true && isDone[0] && isDone[1] && isDone[2] && isDone[3] && isDone[4] && isDone[5] && isDone[6] && isDone[7] && isDone[8] && isDone[9] && isDone[10] && isDone[11] && isDone[12] && isDone[13])
        {
